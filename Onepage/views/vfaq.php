                ...
                <div class="container">
                    ...
                    <div class="clearfix">
                        ...
                        <nav class="main-navigation submenu-flipIn">
                            <ul class="menu">
                                <li><a href="<?php echo base_url('index.php/Onepage'); ?>">Beranda</a></li>
        ...
        <!-- Features -->
                    <div class="row">
                        <div class="col-md-4" style="border-right:2px solid white; padding-left:15px;">
                            ...
                            <div class="testi-detail">
                                <p style="font-size:13px;color:white;text-align:center;">
                                     Kirim SMS ke nomor 0856 9367 8575 dengan format
Nama Lengkap_Asal Sekolah_Kode Peserta_Nominal Transfer 
dan
Kirim bukti pembayaran ke email katalisbimbelipb@gmail.com atau WA/LINE/BBM ke nomor 0856 9367 8575 
                                </p> 
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-5 pull-left">
                            ...
                            <br>
                            <br>
                            <div class="sosmed"><a href="https://www.facebook.com/"><i class="fa fa-facebook fa-2x"></i></a></div>
                            <div class="sosmed"><a href="https://twitter.com/"> <i class="fa fa-twitter fa-2x"></i></a></div>
