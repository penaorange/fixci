                            ...
                            foreach ($peserta as $value) {
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        ...
                                        <a data-toggle="modal" class="btn btn-primary"  href="<?= site_url('Bimbel') ?>">Kembali</a>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <?php $this->session->unset_userdata($value->nm_peserta . $value->no_hp); ?>
                <form action="<?= site_url('Bimbel/ubahPeserta') ?>" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group input-group">
                            ...
                            <select class="form-control" name="kelompokpeserta" required>
                                ...
                                <?php } else if ($value->status == "2") { ?>
                                    ...
                                    <option value="2" selected>Trial</option>
                                    <option value="3">Bimbel</option>
                                <?php } else { ?>
                                    <option value="1" >Trial</option>
                        ...
                        <input name="password" type="hidden" class="form-control"  placeholder="Password" value="<?= $value->password ?>" required> 
