                ...
                <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="<?= site_url('Berbayar/tambahPeserta') ?>" method="post">
                    ...
                    <tbody>
                        ...
                        foreach ($peserta as $value) {
                            ...
                            <tr>
                                ...
                                <td><a href="<?= site_url('Berbayar') ?>/<?= $value->id_peserta ?>"><?= $value->nm_peserta ?></a><?php
...
<script>
    ...
    function openModal(target, type, id) {
        if (type == 'update') {
            $.get(base_url + 'Berbayar/data/' + id, function (res) {
                res = $.parseJSON(res);
        ...
        if (type == 'hapus') {
            $.ajax({
                url: base_url + 'Berbayar/hapusPeserta/'+id,
                type: 'POST',
