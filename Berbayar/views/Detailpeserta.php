                            ...
                            foreach ($peserta as $value) {
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 input-group" style="left: 15px;">
                                            <div class="input-group">
                                                <input type="password" name="viewpassword" id="viewpassword" class="form-control" disabled value="<?= $value->password ?>">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        ...
                                        <a data-toggle="modal" class="btn btn-primary"  href="<?= site_url('Berbayar') ?>">Kembali</a>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= site_url('Berbayar/ubahPeserta') ?>" method="post">
    ...
    <div class="modal fade" id="myModals" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= site_url('Berbayar/hapusPeserta') ?>?id=<?= $value->id_peserta ?>" method="post">
                    <div class="modal-body">
