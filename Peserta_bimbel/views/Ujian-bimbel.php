              ...
              <ul class="nav pull-right top-menu navbar-right">
                    ...
                    <a href="#" class="dropdown-toggle logout" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span> Profil</a>
                      <ul class="dropdown-menu">
                          <li><a href="<?php echo site_url('profil-bimbel');?>"><span class="glyphicon glyphicon-user"></span> Lihat Profil</a></li>
       ...
       <aside>
          <div id="sidebar" class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <p class="centered"><a href="<?php echo site_url('peserta-bimbel');?>"><img src="<?php echo base_url();?>assets/dist/img/fr-05.jpg" class="img-circle" width="60"></a></p>
                  <h5 class="centered">User</h5>
                    
                  <li class="mt">
                      <a href="<?php echo site_url('peserta-bimbel');?>">
