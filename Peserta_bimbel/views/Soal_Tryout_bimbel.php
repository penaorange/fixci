                          ...
                          <?php else: ?>
                            ...
                            <div class="content tryout-soal">
                              ...
                              <div class="paginate pagination pagination-lg">
                                <div class="items">
                                <form id="hasil" class="form_hasil" action="<?php echo site_url('cek-TO-bimbel') ?>" method="post" onsubmit="return deleteAllCookies('seconds', 'minutes');">
                                  ...
                                  <div class="konten">
                                    ...
                                    <div class="media" id="soal<?php echo $i; ?>">
                                      ...
                                      <div class="media-body">
                                        ...
                                        <?php endif; ?>
                                          <h4 class="media-heading soal-cerita breadcrumb"><?php echo $key->soal ;?></h4>
                                      </div>
                                    </div>
