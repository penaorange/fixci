                ...
                <div class="row">
                        ...
                        <div class="card">
                          <div class="header text-center">
                              ...
                              <a href="<?php echo site_url('peserta-bimbel') ?>"><button type="button" class="btn btn-primary pull-right btn-fill" onclick="deleteAllCookies('seconds', 'minutes')"><i class="fa fa-arrow-left"></i> Kembali</button></a>
                              <hr/>
                          </div>
...
<!-- end modular -->
<?php $this->load->view('PesertaModular/Bimbel/FooterResult'); ?>
