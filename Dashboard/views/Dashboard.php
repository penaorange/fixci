        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                    <div class="inner">
                        <h3><?php
                            foreach ($totalpesertaTrial as $value) {
                                echo $value->total;
                                ?>
                            <?php } ?></h3>
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-yellow">
                    <div class="inner">
                        <h3><?php
                            foreach ($totalpesertaBerbayar as $value) {
                                echo $value->total;
                                ?>
                            <?php } ?></h3>
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-red">
                    <div class="inner">
                        <h3><?php
                            foreach ($totalpesertaBimbel as $value) {
                                echo $value->total;
                                ?>
                            <?php } ?></h3>
